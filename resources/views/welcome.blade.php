...
@section('content')
    ...
    <section class="bg-gradient-to-r from-blue-400 via-cyan-300 to-indigo-400 text-gray-800 py-20 relative">
        <div class="container mx-auto text-center">
            <h1 class="text-5xl font-extrabold leading-tight mb-4 animate-bounce text-gray-900">Hello, I'm Prabesh Acharya</h1>
            <p class="text-lg font-bold mb-6 text-black">A passionate Full-Stack Developer crafting web solutions that make a difference.</p>
...
<section class="py-16 bg-gray-50" id="about">
    <div class="container mx-auto text-center">
        <h2 class="text-4xl font-bold mb-6 text-indigo-600"><i class="ri-user-heart-line text-purple-600"></i> Who I Am</h2>
        <p class="text-gray-700 max-w-4xl mx-auto mb-8 text-lg leading-relaxed">
        ...
        <a href="#projects" class="text-indigo-600 font-semibold hover:underline transition-all duration-300 transform hover:scale-105">
...
<section class="py-16 bg-white">
    <div class="container mx-auto text-center">
        <h2 class="text-4xl font-bold mb-8 text-indigo-600"><i class="ri-tools-line text-green-600"></i> Skills</h2>
...
<section class="py-16 bg-gray-100" id="projects">
    <div class="container mx-auto text-center">
        <h2 class="text-4xl font-bold mb-8 text-indigo-600"><i class="ri-lightbulb-line text-yellow-600"></i> Featured Projects</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
                <img src="{{ asset('trekHimal.jpg') }}" alt="YatraSathi" class="w-full h-48 object-cover">
                <div class="p-6">
                    <h3 class="font-bold text-lg mb-2 text-indigo-600">YatraSathi<i class="ri-plane-fill text-blue-600"></i></h3>
                    ...
                    <a href="#" class="text-indigo-600 font-semibold hover:underline transition-all duration-300 transform hover:scale-105">View Project <i class="ri-arrow-right-line ml-2"></i></a>
                </div>
            </div>
            <!-- Project 2 -->
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
                <img src="{{ asset('packingtips1.jpg') }}" alt="E-Commerce Website" class="w-full h-48 object-cover">
                <div class="p-6">
                    <h3 class="font-bold text-lg mb-2 text-green-600">E-Commerce Website<i class="ri-shopping-cart-fill text-green-600"></i></h3>
            ...
            <!-- Project 3 -->
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
                <img src="{{ asset('foodcircle.jpg') }}" alt="FoodCircle" class="w-full h-48 object-cover">
                <div class="p-6">
                    <h3 class="font-bold text-lg mb-2 text-red-600">FoodCircle<i class="ri-restaurant-line text-red-600"></i></h3>
...
<section class="bg-gradient-to-r from-blue-300 to-cyan-300 text-gray-800 py-16">
    <div class="container mx-auto text-center">
        <h2 class="text-5xl font-bold mb-6 text-indigo-600">Want to work together?</h2>
        <p class="text-lg mb-8 text-gray-700">Let's build something amazing! Reach out to discuss your project ideas. I'm excited to collaborate and bring your vision to life.</p>
        <a href="{{ route('contact') }}" id="contact-btn" class="bg-white text-indigo-500 px-8 py-3 rounded-lg text-xl hover:bg-indigo-200 hover:text-indigo-800 transition-all duration-300 transform hover:scale-105">
